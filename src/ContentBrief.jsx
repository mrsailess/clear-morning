            ...
            <div style={{ display: "flex", gap: "10px" }}>
              {MOODS.map((m) => (
                <button key={m.id}
                  ...
                  style={{ flex: 1, background: mood === m.id ? config.surface : "transparent", border: `1px solid ${mood === m.id ? accent : "#222"}`, borderRadius: "10px", padding: "14px 10px", cursor: "pointer", textAlign: "center" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
              {TOPICS[brand].map((t) => (
                <button key={t}
                  ...
                  style={{ background: topic === t ? config.surface : "transparent", border: `1px solid ${topic === t ? accent : "#222"}`, borderRadius: "8px", padding: "12px 14px", cursor: "pointer", textAlign: "left", fontSize: "13px", color: topic === t ? accent : "#888", fontWeight: topic === t ? "600" : "400" }}>{t}</button>
              ))}
            </div>
